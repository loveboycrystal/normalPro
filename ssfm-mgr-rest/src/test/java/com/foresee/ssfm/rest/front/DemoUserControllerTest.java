package com.foresee.ssfm.rest.front;
...
public class DemoUserControllerTest extends BaseSpringWebTest {
    ...
    public void setUp() throws Exception {
        ...
        DemoUserControllerTest.userName = dataConfigHelper.getUserName();
    }
    ...
    public void getDemoUserByUserId() throws Exception {
        DemoUserDTO demoUserDTO = demoUserService.findDemoUserByUserName(DemoUserControllerTest.userName);
        ...
        RestRequestBuilder mockRestRequest = RestRequestBuilder.create("100010001").post("/front/DemoUserService/getDemoUserByUserId").userId("111111111111")
